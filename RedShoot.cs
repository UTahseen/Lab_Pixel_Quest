...
public class RedShoot : MonoBehaviour
{
    ...
    private void SpawnBullet()
    {
        ...
        if (!Input.GetKey(KeyCode.Keypad2) || !_canShoot) { return; }
        // Create a copy of the bullet
        var bullet = Instantiate(preFab, playerRenderer.flipX ? bulletSpawn1.position : bulletSpawn2.position, Quaternion.identity);

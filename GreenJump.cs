...
public class GreenJump : MonoBehaviour
{
    ...
    public Transform feetCollision;
    ...
    void Update()
    {
        bool groundCheck = Physics2D.OverlapCapsule(feetCollision.position, new Vector2(1, 0.08f), CapsuleDirection2D.Horizontal, 0, groundMask);
